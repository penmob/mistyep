...
var mistyepMin = require('../index.min');

var runTests = function (mistyep, isMinified) {
  describe('#mistyep' + (isMinified ? ' (minified)' : ''), function() {
...
runTests(mistyep, false);
runTests(mistyepMin, true);